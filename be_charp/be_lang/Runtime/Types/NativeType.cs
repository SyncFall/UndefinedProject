...
namespace Be.Runtime.Types
{
    ...
    public class NativeTypeCollection : ListCollection<NativeSymbol>
    { }
    ...
    public static class Natives
    {
        ...
        static Natives()
        {
            for(int i=0; i<Array.Length; i++)
            {
                ...
                StringMap.Add(nativeType.Name, nativeType);
            }
        }
        ...
        public static int GetIndexByName(string TypeName)
        {
            for (int i = 0; i < Array.Length; i++)
            {
                if (Array[i].Name.Equals(TypeName))
                {
                    return i;
                }
            }
    ...
    public class NativeUtils
    {
        ...
        public static NativeSymbol GetHighestPrecisionNativeType(NativeSymbol one, NativeSymbol two)
        {
            ...
            if (Natives.GetIndexByName(one.Name) > Natives.GetIndexByName(two.Name))
            {
                result = one;
            }
            else
