...
namespace Be.Runtime.Types
{
    ...
    public class GenericSignaturElementType
    {
        ...
        public bool EqualSignatur(GenericSignaturElementType compare)
        {
            ...
            else if (this.ObjectType != null && !this.ObjectType.String.Equals(compare.ObjectType))
            {
                return false;
            }
            ...
            else if (this.ExtendObjectType != null && !this.ExtendObjectType.String.Equals(compare.ExtendObjectType))
            {
                return false;
            }
