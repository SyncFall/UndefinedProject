...
namespace Be.UI.Types
{
    ...
    {
        public VertextShaderType(string Source, string[] Attributes) : base(Source, ShaderTypeEnum.VERTEX, Attributes)
        { }
    }

    public class FragmentShaderType : BaseShaderType
    {
        public FragmentShaderType(string Source, string[] Attributes) : base(Source, ShaderTypeEnum.FRAGMENT, Attributes)
        { }
    }
    ...
    public class BaseShaderType
    {
        ...
        public ShaderTypeEnum Type;
        public int HandleId;
        public int ProgramId;
        public ShaderPropertyCollection Attributes = new ShaderPropertyCollection();

        public BaseShaderType(string Source, ShaderTypeEnum Type, string[] AttributeKeys)
        {
            this.Source = Source;
            this.Type = Type;
        ...
        public void Create()
        {
            ...
            else if (Type == ShaderTypeEnum.FRAGMENT)
            {
