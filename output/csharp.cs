...
;
	...
	public class Visual0 : VisualObject
	{
		...
		public Visual0(Editor Object)
		{
			...
			this.Visual = 
			element = new VisualElement(VisualElementType.Block, parent);
...
element.AddChild(this.Object.actionBar.Root.Visual);
			...
			stack.Push(parent);
			parent = element;
			element = new VisualElement(VisualElementType.Column, parent);
...
element.AddChild(this.Object.workspace.Root.Visual);
	...
	public class Visual1 : VisualObject
	{
		...
		public Visual1(ActionBar Object)
		{
			...
			stack.Push(parent);
			parent = element;
			element = new VisualElement(VisualElementType.Inline, parent);
			stack.Push(parent);
			parent = element;
