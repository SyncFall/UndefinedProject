...
namespace Feltic
{
    public static class Utils
    {
        ...
        public static void PrintSourceTreeStatistics(string ProjectDirectory)
        {
            ...
            Console.WriteLine("Project-Size: " + (byteCount / 1024) + " KBytes | Source-Files: " + files.Length + " | Line-Count: " + lineCount + " | Class-Objects: " + objectCount + " | Control-Blocks: " + blockCount + " | Code-Statements: " + statementCount);
        }
    }
}
