...
namespace Bee.UI.Triangulator
{
    public class Matrix4f
    {
        ...
        public float m32;
        public float m33;
        private static readonly double EPS = 1.0E-008D;

        public Matrix4f(float paramFloat1, float paramFloat2, float paramFloat3, float paramFloat4, float paramFloat5,
                float paramFloat6, float paramFloat7, float paramFloat8, float paramFloat9, float paramFloat10,
                float paramFloat11, float paramFloat12, float paramFloat13, float paramFloat14, float paramFloat15,
                float paramFloat16)
        {
        ...
        public void setElement(int paramInt1, int paramInt2, float paramFloat)
        {
            switch (paramInt1)
            {
                case 0:
        ...
        public float getElement(int paramInt1, int paramInt2)
        {
            switch (paramInt1)
            {
                case 0:
            ...
            throw new Exception("Matrix4f1");
        }

        /*
        public void getRow(int paramInt, Vector4f paramVector4f)
        {
            if (paramInt == 0)
            {
        ...
        */
        ...
        public void getRow(int paramInt, float[] paramArrayOfFloat)
        {
            if (paramInt == 0)
            {
            ...
            {
                throw new Exception("Matrix4f2");
            }
        }

        /*
        public void getColumn(int paramInt, Vector4f paramVector4f)
        {
            if (paramInt == 0)
            {
                paramVector4f.x = this.m00;
        ...
        */
        ...
        public void getColumn(int paramInt, float[] paramArrayOfFloat)
        {
            if (paramInt == 0)
            {
                paramArrayOfFloat[0] = this.m00;
        ...
        {
            this.m00 = (paramMatrix4f.m00 + paramFloat);
            this.m01 = (paramMatrix4f.m01 + paramFloat);
            this.m02 = (paramMatrix4f.m02 + paramFloat);
            this.m03 = (paramMatrix4f.m03 + paramFloat);
            this.m10 = (paramMatrix4f.m10 + paramFloat);
            this.m11 = (paramMatrix4f.m11 + paramFloat);
            this.m12 = (paramMatrix4f.m12 + paramFloat);
            this.m13 = (paramMatrix4f.m13 + paramFloat);
            this.m20 = (paramMatrix4f.m20 + paramFloat);
            this.m21 = (paramMatrix4f.m21 + paramFloat);
            this.m22 = (paramMatrix4f.m22 + paramFloat);
            this.m23 = (paramMatrix4f.m23 + paramFloat);
            this.m30 = (paramMatrix4f.m30 + paramFloat);
            this.m31 = (paramMatrix4f.m31 + paramFloat);
            this.m32 = (paramMatrix4f.m32 + paramFloat);
            this.m33 = (paramMatrix4f.m33 + paramFloat);
        }

        public final void add(Matrix4f paramMatrix4f1, Matrix4f paramMatrix4f2)
        {
            this.m00 = (paramMatrix4f1.m00 + paramMatrix4f2.m00);
            this.m01 = (paramMatrix4f1.m01 + paramMatrix4f2.m01);
            this.m02 = (paramMatrix4f1.m02 + paramMatrix4f2.m02);
            this.m03 = (paramMatrix4f1.m03 + paramMatrix4f2.m03);

            this.m10 = (paramMatrix4f1.m10 + paramMatrix4f2.m10);
            this.m11 = (paramMatrix4f1.m11 + paramMatrix4f2.m11);
            this.m12 = (paramMatrix4f1.m12 + paramMatrix4f2.m12);
            this.m13 = (paramMatrix4f1.m13 + paramMatrix4f2.m13);

            this.m20 = (paramMatrix4f1.m20 + paramMatrix4f2.m20);
            this.m21 = (paramMatrix4f1.m21 + paramMatrix4f2.m21);
            this.m22 = (paramMatrix4f1.m22 + paramMatrix4f2.m22);
            this.m23 = (paramMatrix4f1.m23 + paramMatrix4f2.m23);

            this.m30 = (paramMatrix4f1.m30 + paramMatrix4f2.m30);
            this.m31 = (paramMatrix4f1.m31 + paramMatrix4f2.m31);
            this.m32 = (paramMatrix4f1.m32 + paramMatrix4f2.m32);
            this.m33 = (paramMatrix4f1.m33 + paramMatrix4f2.m33);
        }
        ...
        {
            float f1 = (float)Math.sqrt(paramAxisAngle4f.x * paramAxisAngle4f.x + paramAxisAngle4f.y * paramAxisAngle4f.y
                    + paramAxisAngle4f.z * paramAxisAngle4f.z);
            if (f1 < 1.0E-008D)
            {
                this.m00 = 1.0F;
                this.m01 = 0.0F;
        ...
        {
            double d1 = Math.sqrt(paramAxisAngle4d.x * paramAxisAngle4d.x + paramAxisAngle4d.y * paramAxisAngle4d.y
                    + paramAxisAngle4d.z * paramAxisAngle4d.z);
        ...
        {
            this.m00 = (float)(paramDouble
                    * (1.0D - (2.0D * paramQuat4d.y * paramQuat4d.y) - (2.0D * paramQuat4d.z * paramQuat4d.z)));
            ...
            this.m11 = (float)(paramDouble
                    * (1.0D - (2.0D * paramQuat4d.x * paramQuat4d.x) - (2.0D * paramQuat4d.z * paramQuat4d.z)));
            ...
            this.m22 = (float)(paramDouble
                    * (1.0D - (2.0D * paramQuat4d.x * paramQuat4d.x) - (2.0D * paramQuat4d.y * paramQuat4d.y)));
        ...
        {
            this.m00 = (paramFloat
                    * (1.0F - (2.0F * paramQuat4f.y * paramQuat4f.y) - (2.0F * paramQuat4f.z * paramQuat4f.z)));
            ...
            this.m11 = (paramFloat
                    * (1.0F - (2.0F * paramQuat4f.x * paramQuat4f.x) - (2.0F * paramQuat4f.z * paramQuat4f.z)));
            ...
            this.m22 = (paramFloat
                    * (1.0F - (2.0F * paramQuat4f.x * paramQuat4f.x) - (2.0F * paramQuat4f.y * paramQuat4f.y)));
        ...
        static boolean luDecomposition(double[] paramArrayOfDouble, int[] paramArrayOfInt)
        {
            ...
            for (d1 = 0; d1 < 4; ++d1)
            {
                ...
                {
                    l = i + 4 * d2 + d1;
                    d5 = paramArrayOfDouble[l];
                    d3 = d2;
                    i1 = i + 4 * d2;
                    i2 = i + d1;
                    while (d3-- != 0)
                    {
                        d5 -= paramArrayOfDouble[i1] * paramArrayOfDouble[i2];
                        ++i1;
                        i2 += 4;
                    }
                    paramArrayOfDouble[l] = d5;
                }
        ...
        static void luBacksubstitution(double[] paramArrayOfDouble1, int[] paramArrayOfInt, double[] paramArrayOfDouble2)
        {
            ...
            for (int i1 = 0; i1 < 4; ++i1)
            {
                ...
                for (int i = 0; i < 4; ++i)
                {
                    int k = paramArrayOfInt[(i2 + i)];
                    double d = paramArrayOfDouble2[(i3 + 4 * k)];
                    paramArrayOfDouble2[(i3 + 4 * k)] = paramArrayOfDouble2[(i3 + 4 * i)];
                    if (j >= 0)
                    {
                        i4 = i * 4;
                        for (int l = j; ; ++l)
                        {
                            if (l > i - 1)
                                break label122;
                            d -= paramArrayOfDouble1[(i4 + l)] * paramArrayOfDouble2[(i3 + 4 * l)];
                        }
                    }
                    if (d != 0.0D)
                    {
                ...
                label122: paramArrayOfDouble2[(i3 + 4 * i)] = d;
                }

                int i4 = 12;
                paramArrayOfDouble2[(i3 + 12)] /= paramArrayOfDouble1[(i4 + 3)];

                i4 -= 4;
                paramArrayOfDouble2[(i3 + 8)] = ((paramArrayOfDouble2[(i3 + 8)]
                        - (paramArrayOfDouble1[(i4 + 3)] * paramArrayOfDouble2[(i3 + 12)]))
                        / paramArrayOfDouble1[(i4 + 2)]);

                i4 -= 4;
                paramArrayOfDouble2[(i3 + 4)] = ((paramArrayOfDouble2[(i3 + 4)]
                        - (paramArrayOfDouble1[(i4 + 2)] * paramArrayOfDouble2[(i3 + 8)])
                        - (paramArrayOfDouble1[(i4 + 3)] * paramArrayOfDouble2[(i3 + 12)]))
                        / paramArrayOfDouble1[(i4 + 1)]);

                i4 -= 4;
                paramArrayOfDouble2[(i3 + 0)] = ((paramArrayOfDouble2[(i3 + 0)]
                        - (paramArrayOfDouble1[(i4 + 1)] * paramArrayOfDouble2[(i3 + 4)])
                        - (paramArrayOfDouble1[(i4 + 2)] * paramArrayOfDouble2[(i3 + 8)])
                        - (paramArrayOfDouble1[(i4 + 3)] * paramArrayOfDouble2[(i3 + 12)]))
                        / paramArrayOfDouble1[(i4 + 0)]);
            }
        }
        ...
        {
            float f1 = this.m00 * paramMatrix4f.m00 + this.m01 * paramMatrix4f.m10 + this.m02 * paramMatrix4f.m20
                    + this.m03 * paramMatrix4f.m30;

            float f2 = this.m00 * paramMatrix4f.m01 + this.m01 * paramMatrix4f.m11 + this.m02 * paramMatrix4f.m21
                    + this.m03 * paramMatrix4f.m31;

            float f3 = this.m00 * paramMatrix4f.m02 + this.m01 * paramMatrix4f.m12 + this.m02 * paramMatrix4f.m22
                    + this.m03 * paramMatrix4f.m32;

            float f4 = this.m00 * paramMatrix4f.m03 + this.m01 * paramMatrix4f.m13 + this.m02 * paramMatrix4f.m23
                    + this.m03 * paramMatrix4f.m33;

            float f5 = this.m10 * paramMatrix4f.m00 + this.m11 * paramMatrix4f.m10 + this.m12 * paramMatrix4f.m20
                    + this.m13 * paramMatrix4f.m30;

            float f6 = this.m10 * paramMatrix4f.m01 + this.m11 * paramMatrix4f.m11 + this.m12 * paramMatrix4f.m21
                    + this.m13 * paramMatrix4f.m31;

            float f7 = this.m10 * paramMatrix4f.m02 + this.m11 * paramMatrix4f.m12 + this.m12 * paramMatrix4f.m22
                    + this.m13 * paramMatrix4f.m32;

            float f8 = this.m10 * paramMatrix4f.m03 + this.m11 * paramMatrix4f.m13 + this.m12 * paramMatrix4f.m23
                    + this.m13 * paramMatrix4f.m33;

            float f9 = this.m20 * paramMatrix4f.m00 + this.m21 * paramMatrix4f.m10 + this.m22 * paramMatrix4f.m20
                    + this.m23 * paramMatrix4f.m30;

            float f10 = this.m20 * paramMatrix4f.m01 + this.m21 * paramMatrix4f.m11 + this.m22 * paramMatrix4f.m21
                    + this.m23 * paramMatrix4f.m31;

            float f11 = this.m20 * paramMatrix4f.m02 + this.m21 * paramMatrix4f.m12 + this.m22 * paramMatrix4f.m22
                    + this.m23 * paramMatrix4f.m32;

            float f12 = this.m20 * paramMatrix4f.m03 + this.m21 * paramMatrix4f.m13 + this.m22 * paramMatrix4f.m23
                    + this.m23 * paramMatrix4f.m33;

            float f13 = this.m30 * paramMatrix4f.m00 + this.m31 * paramMatrix4f.m10 + this.m32 * paramMatrix4f.m20
                    + this.m33 * paramMatrix4f.m30;

            float f14 = this.m30 * paramMatrix4f.m01 + this.m31 * paramMatrix4f.m11 + this.m32 * paramMatrix4f.m21
                    + this.m33 * paramMatrix4f.m31;

            float f15 = this.m30 * paramMatrix4f.m02 + this.m31 * paramMatrix4f.m12 + this.m32 * paramMatrix4f.m22
                    + this.m33 * paramMatrix4f.m32;

            float f16 = this.m30 * paramMatrix4f.m03 + this.m31 * paramMatrix4f.m13 + this.m32 * paramMatrix4f.m23
                    + this.m33 * paramMatrix4f.m33;
        ...
        public final void mul(Matrix4f paramMatrix4f1, Matrix4f paramMatrix4f2)
        {
            ...
            {
                this.m00 = (paramMatrix4f1.m00 * paramMatrix4f2.m00 + paramMatrix4f1.m01 * paramMatrix4f2.m10
                        + paramMatrix4f1.m02 * paramMatrix4f2.m20 + paramMatrix4f1.m03 * paramMatrix4f2.m30);

                this.m01 = (paramMatrix4f1.m00 * paramMatrix4f2.m01 + paramMatrix4f1.m01 * paramMatrix4f2.m11
                        + paramMatrix4f1.m02 * paramMatrix4f2.m21 + paramMatrix4f1.m03 * paramMatrix4f2.m31);

                this.m02 = (paramMatrix4f1.m00 * paramMatrix4f2.m02 + paramMatrix4f1.m01 * paramMatrix4f2.m12
                        + paramMatrix4f1.m02 * paramMatrix4f2.m22 + paramMatrix4f1.m03 * paramMatrix4f2.m32);

                this.m03 = (paramMatrix4f1.m00 * paramMatrix4f2.m03 + paramMatrix4f1.m01 * paramMatrix4f2.m13
                        + paramMatrix4f1.m02 * paramMatrix4f2.m23 + paramMatrix4f1.m03 * paramMatrix4f2.m33);

                this.m10 = (paramMatrix4f1.m10 * paramMatrix4f2.m00 + paramMatrix4f1.m11 * paramMatrix4f2.m10
                        + paramMatrix4f1.m12 * paramMatrix4f2.m20 + paramMatrix4f1.m13 * paramMatrix4f2.m30);

                this.m11 = (paramMatrix4f1.m10 * paramMatrix4f2.m01 + paramMatrix4f1.m11 * paramMatrix4f2.m11
                        + paramMatrix4f1.m12 * paramMatrix4f2.m21 + paramMatrix4f1.m13 * paramMatrix4f2.m31);

                this.m12 = (paramMatrix4f1.m10 * paramMatrix4f2.m02 + paramMatrix4f1.m11 * paramMatrix4f2.m12
                        + paramMatrix4f1.m12 * paramMatrix4f2.m22 + paramMatrix4f1.m13 * paramMatrix4f2.m32);

                this.m13 = (paramMatrix4f1.m10 * paramMatrix4f2.m03 + paramMatrix4f1.m11 * paramMatrix4f2.m13
                        + paramMatrix4f1.m12 * paramMatrix4f2.m23 + paramMatrix4f1.m13 * paramMatrix4f2.m33);

                this.m20 = (paramMatrix4f1.m20 * paramMatrix4f2.m00 + paramMatrix4f1.m21 * paramMatrix4f2.m10
                        + paramMatrix4f1.m22 * paramMatrix4f2.m20 + paramMatrix4f1.m23 * paramMatrix4f2.m30);

                this.m21 = (paramMatrix4f1.m20 * paramMatrix4f2.m01 + paramMatrix4f1.m21 * paramMatrix4f2.m11
                        + paramMatrix4f1.m22 * paramMatrix4f2.m21 + paramMatrix4f1.m23 * paramMatrix4f2.m31);

                this.m22 = (paramMatrix4f1.m20 * paramMatrix4f2.m02 + paramMatrix4f1.m21 * paramMatrix4f2.m12
                        + paramMatrix4f1.m22 * paramMatrix4f2.m22 + paramMatrix4f1.m23 * paramMatrix4f2.m32);

                this.m23 = (paramMatrix4f1.m20 * paramMatrix4f2.m03 + paramMatrix4f1.m21 * paramMatrix4f2.m13
                        + paramMatrix4f1.m22 * paramMatrix4f2.m23 + paramMatrix4f1.m23 * paramMatrix4f2.m33);

                this.m30 = (paramMatrix4f1.m30 * paramMatrix4f2.m00 + paramMatrix4f1.m31 * paramMatrix4f2.m10
                        + paramMatrix4f1.m32 * paramMatrix4f2.m20 + paramMatrix4f1.m33 * paramMatrix4f2.m30);

                this.m31 = (paramMatrix4f1.m30 * paramMatrix4f2.m01 + paramMatrix4f1.m31 * paramMatrix4f2.m11
                        + paramMatrix4f1.m32 * paramMatrix4f2.m21 + paramMatrix4f1.m33 * paramMatrix4f2.m31);

                this.m32 = (paramMatrix4f1.m30 * paramMatrix4f2.m02 + paramMatrix4f1.m31 * paramMatrix4f2.m12
                        + paramMatrix4f1.m32 * paramMatrix4f2.m22 + paramMatrix4f1.m33 * paramMatrix4f2.m32);

                this.m33 = (paramMatrix4f1.m30 * paramMatrix4f2.m03 + paramMatrix4f1.m31 * paramMatrix4f2.m13
                        + paramMatrix4f1.m32 * paramMatrix4f2.m23 + paramMatrix4f1.m33 * paramMatrix4f2.m33);
            }
            else
            {
                float f1 = paramMatrix4f1.m00 * paramMatrix4f2.m00 + paramMatrix4f1.m01 * paramMatrix4f2.m10
                        + paramMatrix4f1.m02 * paramMatrix4f2.m20 + paramMatrix4f1.m03 * paramMatrix4f2.m30;
                float f2 = paramMatrix4f1.m00 * paramMatrix4f2.m01 + paramMatrix4f1.m01 * paramMatrix4f2.m11
                        + paramMatrix4f1.m02 * paramMatrix4f2.m21 + paramMatrix4f1.m03 * paramMatrix4f2.m31;
                float f3 = paramMatrix4f1.m00 * paramMatrix4f2.m02 + paramMatrix4f1.m01 * paramMatrix4f2.m12
                        + paramMatrix4f1.m02 * paramMatrix4f2.m22 + paramMatrix4f1.m03 * paramMatrix4f2.m32;
                float f4 = paramMatrix4f1.m00 * paramMatrix4f2.m03 + paramMatrix4f1.m01 * paramMatrix4f2.m13
                        + paramMatrix4f1.m02 * paramMatrix4f2.m23 + paramMatrix4f1.m03 * paramMatrix4f2.m33;

                float f5 = paramMatrix4f1.m10 * paramMatrix4f2.m00 + paramMatrix4f1.m11 * paramMatrix4f2.m10
                        + paramMatrix4f1.m12 * paramMatrix4f2.m20 + paramMatrix4f1.m13 * paramMatrix4f2.m30;
                float f6 = paramMatrix4f1.m10 * paramMatrix4f2.m01 + paramMatrix4f1.m11 * paramMatrix4f2.m11
                        + paramMatrix4f1.m12 * paramMatrix4f2.m21 + paramMatrix4f1.m13 * paramMatrix4f2.m31;
                float f7 = paramMatrix4f1.m10 * paramMatrix4f2.m02 + paramMatrix4f1.m11 * paramMatrix4f2.m12
                        + paramMatrix4f1.m12 * paramMatrix4f2.m22 + paramMatrix4f1.m13 * paramMatrix4f2.m32;
                float f8 = paramMatrix4f1.m10 * paramMatrix4f2.m03 + paramMatrix4f1.m11 * paramMatrix4f2.m13
                        + paramMatrix4f1.m12 * paramMatrix4f2.m23 + paramMatrix4f1.m13 * paramMatrix4f2.m33;

                float f9 = paramMatrix4f1.m20 * paramMatrix4f2.m00 + paramMatrix4f1.m21 * paramMatrix4f2.m10
                        + paramMatrix4f1.m22 * paramMatrix4f2.m20 + paramMatrix4f1.m23 * paramMatrix4f2.m30;
                float f10 = paramMatrix4f1.m20 * paramMatrix4f2.m01 + paramMatrix4f1.m21 * paramMatrix4f2.m11
                        + paramMatrix4f1.m22 * paramMatrix4f2.m21 + paramMatrix4f1.m23 * paramMatrix4f2.m31;
                float f11 = paramMatrix4f1.m20 * paramMatrix4f2.m02 + paramMatrix4f1.m21 * paramMatrix4f2.m12
                        + paramMatrix4f1.m22 * paramMatrix4f2.m22 + paramMatrix4f1.m23 * paramMatrix4f2.m32;
                float f12 = paramMatrix4f1.m20 * paramMatrix4f2.m03 + paramMatrix4f1.m21 * paramMatrix4f2.m13
                        + paramMatrix4f1.m22 * paramMatrix4f2.m23 + paramMatrix4f1.m23 * paramMatrix4f2.m33;

                float f13 = paramMatrix4f1.m30 * paramMatrix4f2.m00 + paramMatrix4f1.m31 * paramMatrix4f2.m10
                        + paramMatrix4f1.m32 * paramMatrix4f2.m20 + paramMatrix4f1.m33 * paramMatrix4f2.m30;
                float f14 = paramMatrix4f1.m30 * paramMatrix4f2.m01 + paramMatrix4f1.m31 * paramMatrix4f2.m11
                        + paramMatrix4f1.m32 * paramMatrix4f2.m21 + paramMatrix4f1.m33 * paramMatrix4f2.m31;
                float f15 = paramMatrix4f1.m30 * paramMatrix4f2.m02 + paramMatrix4f1.m31 * paramMatrix4f2.m12
                        + paramMatrix4f1.m32 * paramMatrix4f2.m22 + paramMatrix4f1.m33 * paramMatrix4f2.m32;
                float f16 = paramMatrix4f1.m30 * paramMatrix4f2.m03 + paramMatrix4f1.m31 * paramMatrix4f2.m13
                        + paramMatrix4f1.m32 * paramMatrix4f2.m23 + paramMatrix4f1.m33 * paramMatrix4f2.m33;
        ...
        public final void mulTransposeBoth(Matrix4f paramMatrix4f1, Matrix4f paramMatrix4f2)
        {
            if ((this != paramMatrix4f1) && (this != paramMatrix4f2))
            {
                this.m00 = (paramMatrix4f1.m00 * paramMatrix4f2.m00 + paramMatrix4f1.m10 * paramMatrix4f2.m01
                        + paramMatrix4f1.m20 * paramMatrix4f2.m02 + paramMatrix4f1.m30 * paramMatrix4f2.m03);
                this.m01 = (paramMatrix4f1.m00 * paramMatrix4f2.m10 + paramMatrix4f1.m10 * paramMatrix4f2.m11
                        + paramMatrix4f1.m20 * paramMatrix4f2.m12 + paramMatrix4f1.m30 * paramMatrix4f2.m13);
                this.m02 = (paramMatrix4f1.m00 * paramMatrix4f2.m20 + paramMatrix4f1.m10 * paramMatrix4f2.m21
                        + paramMatrix4f1.m20 * paramMatrix4f2.m22 + paramMatrix4f1.m30 * paramMatrix4f2.m23);
                this.m03 = (paramMatrix4f1.m00 * paramMatrix4f2.m30 + paramMatrix4f1.m10 * paramMatrix4f2.m31
                        + paramMatrix4f1.m20 * paramMatrix4f2.m32 + paramMatrix4f1.m30 * paramMatrix4f2.m33);

                this.m10 = (paramMatrix4f1.m01 * paramMatrix4f2.m00 + paramMatrix4f1.m11 * paramMatrix4f2.m01
                        + paramMatrix4f1.m21 * paramMatrix4f2.m02 + paramMatrix4f1.m31 * paramMatrix4f2.m03);
                this.m11 = (paramMatrix4f1.m01 * paramMatrix4f2.m10 + paramMatrix4f1.m11 * paramMatrix4f2.m11
                        + paramMatrix4f1.m21 * paramMatrix4f2.m12 + paramMatrix4f1.m31 * paramMatrix4f2.m13);
                this.m12 = (paramMatrix4f1.m01 * paramMatrix4f2.m20 + paramMatrix4f1.m11 * paramMatrix4f2.m21
                        + paramMatrix4f1.m21 * paramMatrix4f2.m22 + paramMatrix4f1.m31 * paramMatrix4f2.m23);
                this.m13 = (paramMatrix4f1.m01 * paramMatrix4f2.m30 + paramMatrix4f1.m11 * paramMatrix4f2.m31
                        + paramMatrix4f1.m21 * paramMatrix4f2.m32 + paramMatrix4f1.m31 * paramMatrix4f2.m33);

                this.m20 = (paramMatrix4f1.m02 * paramMatrix4f2.m00 + paramMatrix4f1.m12 * paramMatrix4f2.m01
                        + paramMatrix4f1.m22 * paramMatrix4f2.m02 + paramMatrix4f1.m32 * paramMatrix4f2.m03);
                this.m21 = (paramMatrix4f1.m02 * paramMatrix4f2.m10 + paramMatrix4f1.m12 * paramMatrix4f2.m11
                        + paramMatrix4f1.m22 * paramMatrix4f2.m12 + paramMatrix4f1.m32 * paramMatrix4f2.m13);
                this.m22 = (paramMatrix4f1.m02 * paramMatrix4f2.m20 + paramMatrix4f1.m12 * paramMatrix4f2.m21
                        + paramMatrix4f1.m22 * paramMatrix4f2.m22 + paramMatrix4f1.m32 * paramMatrix4f2.m23);
                this.m23 = (paramMatrix4f1.m02 * paramMatrix4f2.m30 + paramMatrix4f1.m12 * paramMatrix4f2.m31
                        + paramMatrix4f1.m22 * paramMatrix4f2.m32 + paramMatrix4f1.m32 * paramMatrix4f2.m33);

                this.m30 = (paramMatrix4f1.m03 * paramMatrix4f2.m00 + paramMatrix4f1.m13 * paramMatrix4f2.m01
                        + paramMatrix4f1.m23 * paramMatrix4f2.m02 + paramMatrix4f1.m33 * paramMatrix4f2.m03);
                this.m31 = (paramMatrix4f1.m03 * paramMatrix4f2.m10 + paramMatrix4f1.m13 * paramMatrix4f2.m11
                        + paramMatrix4f1.m23 * paramMatrix4f2.m12 + paramMatrix4f1.m33 * paramMatrix4f2.m13);
                this.m32 = (paramMatrix4f1.m03 * paramMatrix4f2.m20 + paramMatrix4f1.m13 * paramMatrix4f2.m21
                        + paramMatrix4f1.m23 * paramMatrix4f2.m22 + paramMatrix4f1.m33 * paramMatrix4f2.m23);
                this.m33 = (paramMatrix4f1.m03 * paramMatrix4f2.m30 + paramMatrix4f1.m13 * paramMatrix4f2.m31
                        + paramMatrix4f1.m23 * paramMatrix4f2.m32 + paramMatrix4f1.m33 * paramMatrix4f2.m33);
            }
            else
            {
                float f1 = paramMatrix4f1.m00 * paramMatrix4f2.m00 + paramMatrix4f1.m10 * paramMatrix4f2.m01
                        + paramMatrix4f1.m20 * paramMatrix4f2.m02 + paramMatrix4f1.m30 * paramMatrix4f2.m03;
                float f2 = paramMatrix4f1.m00 * paramMatrix4f2.m10 + paramMatrix4f1.m10 * paramMatrix4f2.m11
                        + paramMatrix4f1.m20 * paramMatrix4f2.m12 + paramMatrix4f1.m30 * paramMatrix4f2.m13;
                float f3 = paramMatrix4f1.m00 * paramMatrix4f2.m20 + paramMatrix4f1.m10 * paramMatrix4f2.m21
                        + paramMatrix4f1.m20 * paramMatrix4f2.m22 + paramMatrix4f1.m30 * paramMatrix4f2.m23;
                float f4 = paramMatrix4f1.m00 * paramMatrix4f2.m30 + paramMatrix4f1.m10 * paramMatrix4f2.m31
                        + paramMatrix4f1.m20 * paramMatrix4f2.m32 + paramMatrix4f1.m30 * paramMatrix4f2.m33;

                float f5 = paramMatrix4f1.m01 * paramMatrix4f2.m00 + paramMatrix4f1.m11 * paramMatrix4f2.m01
                        + paramMatrix4f1.m21 * paramMatrix4f2.m02 + paramMatrix4f1.m31 * paramMatrix4f2.m03;
                float f6 = paramMatrix4f1.m01 * paramMatrix4f2.m10 + paramMatrix4f1.m11 * paramMatrix4f2.m11
                        + paramMatrix4f1.m21 * paramMatrix4f2.m12 + paramMatrix4f1.m31 * paramMatrix4f2.m13;
                float f7 = paramMatrix4f1.m01 * paramMatrix4f2.m20 + paramMatrix4f1.m11 * paramMatrix4f2.m21
                        + paramMatrix4f1.m21 * paramMatrix4f2.m22 + paramMatrix4f1.m31 * paramMatrix4f2.m23;
                float f8 = paramMatrix4f1.m01 * paramMatrix4f2.m30 + paramMatrix4f1.m11 * paramMatrix4f2.m31
                        + paramMatrix4f1.m21 * paramMatrix4f2.m32 + paramMatrix4f1.m31 * paramMatrix4f2.m33;

                float f9 = paramMatrix4f1.m02 * paramMatrix4f2.m00 + paramMatrix4f1.m12 * paramMatrix4f2.m01
                        + paramMatrix4f1.m22 * paramMatrix4f2.m02 + paramMatrix4f1.m32 * paramMatrix4f2.m03;
                float f10 = paramMatrix4f1.m02 * paramMatrix4f2.m10 + paramMatrix4f1.m12 * paramMatrix4f2.m11
                        + paramMatrix4f1.m22 * paramMatrix4f2.m12 + paramMatrix4f1.m32 * paramMatrix4f2.m13;
                float f11 = paramMatrix4f1.m02 * paramMatrix4f2.m20 + paramMatrix4f1.m12 * paramMatrix4f2.m21
                        + paramMatrix4f1.m22 * paramMatrix4f2.m22 + paramMatrix4f1.m32 * paramMatrix4f2.m23;
                float f12 = paramMatrix4f1.m02 * paramMatrix4f2.m30 + paramMatrix4f1.m12 * paramMatrix4f2.m31
                        + paramMatrix4f1.m22 * paramMatrix4f2.m32 + paramMatrix4f1.m32 * paramMatrix4f2.m33;

                float f13 = paramMatrix4f1.m03 * paramMatrix4f2.m00 + paramMatrix4f1.m13 * paramMatrix4f2.m01
                        + paramMatrix4f1.m23 * paramMatrix4f2.m02 + paramMatrix4f1.m33 * paramMatrix4f2.m03;
                float f14 = paramMatrix4f1.m03 * paramMatrix4f2.m10 + paramMatrix4f1.m13 * paramMatrix4f2.m11
                        + paramMatrix4f1.m23 * paramMatrix4f2.m12 + paramMatrix4f1.m33 * paramMatrix4f2.m13;
                float f15 = paramMatrix4f1.m03 * paramMatrix4f2.m20 + paramMatrix4f1.m13 * paramMatrix4f2.m21
                        + paramMatrix4f1.m23 * paramMatrix4f2.m22 + paramMatrix4f1.m33 * paramMatrix4f2.m23;
                float f16 = paramMatrix4f1.m03 * paramMatrix4f2.m30 + paramMatrix4f1.m13 * paramMatrix4f2.m31
                        + paramMatrix4f1.m23 * paramMatrix4f2.m32 + paramMatrix4f1.m33 * paramMatrix4f2.m33;
        ...
        public final void mulTransposeRight(Matrix4f paramMatrix4f1, Matrix4f paramMatrix4f2)
        {
            if ((this != paramMatrix4f1) && (this != paramMatrix4f2))
            {
                this.m00 = (paramMatrix4f1.m00 * paramMatrix4f2.m00 + paramMatrix4f1.m01 * paramMatrix4f2.m01
                        + paramMatrix4f1.m02 * paramMatrix4f2.m02 + paramMatrix4f1.m03 * paramMatrix4f2.m03);
                this.m01 = (paramMatrix4f1.m00 * paramMatrix4f2.m10 + paramMatrix4f1.m01 * paramMatrix4f2.m11
                        + paramMatrix4f1.m02 * paramMatrix4f2.m12 + paramMatrix4f1.m03 * paramMatrix4f2.m13);
                this.m02 = (paramMatrix4f1.m00 * paramMatrix4f2.m20 + paramMatrix4f1.m01 * paramMatrix4f2.m21
                        + paramMatrix4f1.m02 * paramMatrix4f2.m22 + paramMatrix4f1.m03 * paramMatrix4f2.m23);
                this.m03 = (paramMatrix4f1.m00 * paramMatrix4f2.m30 + paramMatrix4f1.m01 * paramMatrix4f2.m31
                        + paramMatrix4f1.m02 * paramMatrix4f2.m32 + paramMatrix4f1.m03 * paramMatrix4f2.m33);

                this.m10 = (paramMatrix4f1.m10 * paramMatrix4f2.m00 + paramMatrix4f1.m11 * paramMatrix4f2.m01
                        + paramMatrix4f1.m12 * paramMatrix4f2.m02 + paramMatrix4f1.m13 * paramMatrix4f2.m03);
                this.m11 = (paramMatrix4f1.m10 * paramMatrix4f2.m10 + paramMatrix4f1.m11 * paramMatrix4f2.m11
                        + paramMatrix4f1.m12 * paramMatrix4f2.m12 + paramMatrix4f1.m13 * paramMatrix4f2.m13);
                this.m12 = (paramMatrix4f1.m10 * paramMatrix4f2.m20 + paramMatrix4f1.m11 * paramMatrix4f2.m21
                        + paramMatrix4f1.m12 * paramMatrix4f2.m22 + paramMatrix4f1.m13 * paramMatrix4f2.m23);
                this.m13 = (paramMatrix4f1.m10 * paramMatrix4f2.m30 + paramMatrix4f1.m11 * paramMatrix4f2.m31
                        + paramMatrix4f1.m12 * paramMatrix4f2.m32 + paramMatrix4f1.m13 * paramMatrix4f2.m33);

                this.m20 = (paramMatrix4f1.m20 * paramMatrix4f2.m00 + paramMatrix4f1.m21 * paramMatrix4f2.m01
                        + paramMatrix4f1.m22 * paramMatrix4f2.m02 + paramMatrix4f1.m23 * paramMatrix4f2.m03);
                this.m21 = (paramMatrix4f1.m20 * paramMatrix4f2.m10 + paramMatrix4f1.m21 * paramMatrix4f2.m11
                        + paramMatrix4f1.m22 * paramMatrix4f2.m12 + paramMatrix4f1.m23 * paramMatrix4f2.m13);
                this.m22 = (paramMatrix4f1.m20 * paramMatrix4f2.m20 + paramMatrix4f1.m21 * paramMatrix4f2.m21
                        + paramMatrix4f1.m22 * paramMatrix4f2.m22 + paramMatrix4f1.m23 * paramMatrix4f2.m23);
                this.m23 = (paramMatrix4f1.m20 * paramMatrix4f2.m30 + paramMatrix4f1.m21 * paramMatrix4f2.m31
                        + paramMatrix4f1.m22 * paramMatrix4f2.m32 + paramMatrix4f1.m23 * paramMatrix4f2.m33);

                this.m30 = (paramMatrix4f1.m30 * paramMatrix4f2.m00 + paramMatrix4f1.m31 * paramMatrix4f2.m01
                        + paramMatrix4f1.m32 * paramMatrix4f2.m02 + paramMatrix4f1.m33 * paramMatrix4f2.m03);
                this.m31 = (paramMatrix4f1.m30 * paramMatrix4f2.m10 + paramMatrix4f1.m31 * paramMatrix4f2.m11
                        + paramMatrix4f1.m32 * paramMatrix4f2.m12 + paramMatrix4f1.m33 * paramMatrix4f2.m13);
                this.m32 = (paramMatrix4f1.m30 * paramMatrix4f2.m20 + paramMatrix4f1.m31 * paramMatrix4f2.m21
                        + paramMatrix4f1.m32 * paramMatrix4f2.m22 + paramMatrix4f1.m33 * paramMatrix4f2.m23);
                this.m33 = (paramMatrix4f1.m30 * paramMatrix4f2.m30 + paramMatrix4f1.m31 * paramMatrix4f2.m31
                        + paramMatrix4f1.m32 * paramMatrix4f2.m32 + paramMatrix4f1.m33 * paramMatrix4f2.m33);
            }
            else
            {
                float f1 = paramMatrix4f1.m00 * paramMatrix4f2.m00 + paramMatrix4f1.m01 * paramMatrix4f2.m01
                        + paramMatrix4f1.m02 * paramMatrix4f2.m02 + paramMatrix4f1.m03 * paramMatrix4f2.m03;
                float f2 = paramMatrix4f1.m00 * paramMatrix4f2.m10 + paramMatrix4f1.m01 * paramMatrix4f2.m11
                        + paramMatrix4f1.m02 * paramMatrix4f2.m12 + paramMatrix4f1.m03 * paramMatrix4f2.m13;
                float f3 = paramMatrix4f1.m00 * paramMatrix4f2.m20 + paramMatrix4f1.m01 * paramMatrix4f2.m21
                        + paramMatrix4f1.m02 * paramMatrix4f2.m22 + paramMatrix4f1.m03 * paramMatrix4f2.m23;
                float f4 = paramMatrix4f1.m00 * paramMatrix4f2.m30 + paramMatrix4f1.m01 * paramMatrix4f2.m31
                        + paramMatrix4f1.m02 * paramMatrix4f2.m32 + paramMatrix4f1.m03 * paramMatrix4f2.m33;

                float f5 = paramMatrix4f1.m10 * paramMatrix4f2.m00 + paramMatrix4f1.m11 * paramMatrix4f2.m01
                        + paramMatrix4f1.m12 * paramMatrix4f2.m02 + paramMatrix4f1.m13 * paramMatrix4f2.m03;
                float f6 = paramMatrix4f1.m10 * paramMatrix4f2.m10 + paramMatrix4f1.m11 * paramMatrix4f2.m11
                        + paramMatrix4f1.m12 * paramMatrix4f2.m12 + paramMatrix4f1.m13 * paramMatrix4f2.m13;
                float f7 = paramMatrix4f1.m10 * paramMatrix4f2.m20 + paramMatrix4f1.m11 * paramMatrix4f2.m21
                        + paramMatrix4f1.m12 * paramMatrix4f2.m22 + paramMatrix4f1.m13 * paramMatrix4f2.m23;
                float f8 = paramMatrix4f1.m10 * paramMatrix4f2.m30 + paramMatrix4f1.m11 * paramMatrix4f2.m31
                        + paramMatrix4f1.m12 * paramMatrix4f2.m32 + paramMatrix4f1.m13 * paramMatrix4f2.m33;

                float f9 = paramMatrix4f1.m20 * paramMatrix4f2.m00 + paramMatrix4f1.m21 * paramMatrix4f2.m01
                        + paramMatrix4f1.m22 * paramMatrix4f2.m02 + paramMatrix4f1.m23 * paramMatrix4f2.m03;
                float f10 = paramMatrix4f1.m20 * paramMatrix4f2.m10 + paramMatrix4f1.m21 * paramMatrix4f2.m11
                        + paramMatrix4f1.m22 * paramMatrix4f2.m12 + paramMatrix4f1.m23 * paramMatrix4f2.m13;
                float f11 = paramMatrix4f1.m20 * paramMatrix4f2.m20 + paramMatrix4f1.m21 * paramMatrix4f2.m21
                        + paramMatrix4f1.m22 * paramMatrix4f2.m22 + paramMatrix4f1.m23 * paramMatrix4f2.m23;
                float f12 = paramMatrix4f1.m20 * paramMatrix4f2.m30 + paramMatrix4f1.m21 * paramMatrix4f2.m31
                        + paramMatrix4f1.m22 * paramMatrix4f2.m32 + paramMatrix4f1.m23 * paramMatrix4f2.m33;

                float f13 = paramMatrix4f1.m30 * paramMatrix4f2.m00 + paramMatrix4f1.m31 * paramMatrix4f2.m01
                        + paramMatrix4f1.m32 * paramMatrix4f2.m02 + paramMatrix4f1.m33 * paramMatrix4f2.m03;
                float f14 = paramMatrix4f1.m30 * paramMatrix4f2.m10 + paramMatrix4f1.m31 * paramMatrix4f2.m11
                        + paramMatrix4f1.m32 * paramMatrix4f2.m12 + paramMatrix4f1.m33 * paramMatrix4f2.m13;
                float f15 = paramMatrix4f1.m30 * paramMatrix4f2.m20 + paramMatrix4f1.m31 * paramMatrix4f2.m21
                        + paramMatrix4f1.m32 * paramMatrix4f2.m22 + paramMatrix4f1.m33 * paramMatrix4f2.m23;
                float f16 = paramMatrix4f1.m30 * paramMatrix4f2.m30 + paramMatrix4f1.m31 * paramMatrix4f2.m31
                        + paramMatrix4f1.m32 * paramMatrix4f2.m32 + paramMatrix4f1.m33 * paramMatrix4f2.m33;
        ...
        public final void mulTransposeLeft(Matrix4f paramMatrix4f1, Matrix4f paramMatrix4f2)
        {
            if ((this != paramMatrix4f1) && (this != paramMatrix4f2))
            {
                this.m00 = (paramMatrix4f1.m00 * paramMatrix4f2.m00 + paramMatrix4f1.m10 * paramMatrix4f2.m10
                        + paramMatrix4f1.m20 * paramMatrix4f2.m20 + paramMatrix4f1.m30 * paramMatrix4f2.m30);
                this.m01 = (paramMatrix4f1.m00 * paramMatrix4f2.m01 + paramMatrix4f1.m10 * paramMatrix4f2.m11
                        + paramMatrix4f1.m20 * paramMatrix4f2.m21 + paramMatrix4f1.m30 * paramMatrix4f2.m31);
                this.m02 = (paramMatrix4f1.m00 * paramMatrix4f2.m02 + paramMatrix4f1.m10 * paramMatrix4f2.m12
                        + paramMatrix4f1.m20 * paramMatrix4f2.m22 + paramMatrix4f1.m30 * paramMatrix4f2.m32);
                this.m03 = (paramMatrix4f1.m00 * paramMatrix4f2.m03 + paramMatrix4f1.m10 * paramMatrix4f2.m13
                        + paramMatrix4f1.m20 * paramMatrix4f2.m23 + paramMatrix4f1.m30 * paramMatrix4f2.m33);

                this.m10 = (paramMatrix4f1.m01 * paramMatrix4f2.m00 + paramMatrix4f1.m11 * paramMatrix4f2.m10
                        + paramMatrix4f1.m21 * paramMatrix4f2.m20 + paramMatrix4f1.m31 * paramMatrix4f2.m30);
                this.m11 = (paramMatrix4f1.m01 * paramMatrix4f2.m01 + paramMatrix4f1.m11 * paramMatrix4f2.m11
                        + paramMatrix4f1.m21 * paramMatrix4f2.m21 + paramMatrix4f1.m31 * paramMatrix4f2.m31);
                this.m12 = (paramMatrix4f1.m01 * paramMatrix4f2.m02 + paramMatrix4f1.m11 * paramMatrix4f2.m12
                        + paramMatrix4f1.m21 * paramMatrix4f2.m22 + paramMatrix4f1.m31 * paramMatrix4f2.m32);
                this.m13 = (paramMatrix4f1.m01 * paramMatrix4f2.m03 + paramMatrix4f1.m11 * paramMatrix4f2.m13
                        + paramMatrix4f1.m21 * paramMatrix4f2.m23 + paramMatrix4f1.m31 * paramMatrix4f2.m33);

                this.m20 = (paramMatrix4f1.m02 * paramMatrix4f2.m00 + paramMatrix4f1.m12 * paramMatrix4f2.m10
                        + paramMatrix4f1.m22 * paramMatrix4f2.m20 + paramMatrix4f1.m32 * paramMatrix4f2.m30);
                this.m21 = (paramMatrix4f1.m02 * paramMatrix4f2.m01 + paramMatrix4f1.m12 * paramMatrix4f2.m11
                        + paramMatrix4f1.m22 * paramMatrix4f2.m21 + paramMatrix4f1.m32 * paramMatrix4f2.m31);
                this.m22 = (paramMatrix4f1.m02 * paramMatrix4f2.m02 + paramMatrix4f1.m12 * paramMatrix4f2.m12
                        + paramMatrix4f1.m22 * paramMatrix4f2.m22 + paramMatrix4f1.m32 * paramMatrix4f2.m32);
                this.m23 = (paramMatrix4f1.m02 * paramMatrix4f2.m03 + paramMatrix4f1.m12 * paramMatrix4f2.m13
                        + paramMatrix4f1.m22 * paramMatrix4f2.m23 + paramMatrix4f1.m32 * paramMatrix4f2.m33);

                this.m30 = (paramMatrix4f1.m03 * paramMatrix4f2.m00 + paramMatrix4f1.m13 * paramMatrix4f2.m10
                        + paramMatrix4f1.m23 * paramMatrix4f2.m20 + paramMatrix4f1.m33 * paramMatrix4f2.m30);
                this.m31 = (paramMatrix4f1.m03 * paramMatrix4f2.m01 + paramMatrix4f1.m13 * paramMatrix4f2.m11
                        + paramMatrix4f1.m23 * paramMatrix4f2.m21 + paramMatrix4f1.m33 * paramMatrix4f2.m31);
                this.m32 = (paramMatrix4f1.m03 * paramMatrix4f2.m02 + paramMatrix4f1.m13 * paramMatrix4f2.m12
                        + paramMatrix4f1.m23 * paramMatrix4f2.m22 + paramMatrix4f1.m33 * paramMatrix4f2.m32);
                this.m33 = (paramMatrix4f1.m03 * paramMatrix4f2.m03 + paramMatrix4f1.m13 * paramMatrix4f2.m13
                        + paramMatrix4f1.m23 * paramMatrix4f2.m23 + paramMatrix4f1.m33 * paramMatrix4f2.m33);
            }
            else
            {
                float f1 = paramMatrix4f1.m00 * paramMatrix4f2.m00 + paramMatrix4f1.m10 * paramMatrix4f2.m10
                        + paramMatrix4f1.m20 * paramMatrix4f2.m20 + paramMatrix4f1.m30 * paramMatrix4f2.m30;
                float f2 = paramMatrix4f1.m00 * paramMatrix4f2.m01 + paramMatrix4f1.m10 * paramMatrix4f2.m11
                        + paramMatrix4f1.m20 * paramMatrix4f2.m21 + paramMatrix4f1.m30 * paramMatrix4f2.m31;
                float f3 = paramMatrix4f1.m00 * paramMatrix4f2.m02 + paramMatrix4f1.m10 * paramMatrix4f2.m12
                        + paramMatrix4f1.m20 * paramMatrix4f2.m22 + paramMatrix4f1.m30 * paramMatrix4f2.m32;
                float f4 = paramMatrix4f1.m00 * paramMatrix4f2.m03 + paramMatrix4f1.m10 * paramMatrix4f2.m13
                        + paramMatrix4f1.m20 * paramMatrix4f2.m23 + paramMatrix4f1.m30 * paramMatrix4f2.m33;

                float f5 = paramMatrix4f1.m01 * paramMatrix4f2.m00 + paramMatrix4f1.m11 * paramMatrix4f2.m10
                        + paramMatrix4f1.m21 * paramMatrix4f2.m20 + paramMatrix4f1.m31 * paramMatrix4f2.m30;
                float f6 = paramMatrix4f1.m01 * paramMatrix4f2.m01 + paramMatrix4f1.m11 * paramMatrix4f2.m11
                        + paramMatrix4f1.m21 * paramMatrix4f2.m21 + paramMatrix4f1.m31 * paramMatrix4f2.m31;
                float f7 = paramMatrix4f1.m01 * paramMatrix4f2.m02 + paramMatrix4f1.m11 * paramMatrix4f2.m12
                        + paramMatrix4f1.m21 * paramMatrix4f2.m22 + paramMatrix4f1.m31 * paramMatrix4f2.m32;
                float f8 = paramMatrix4f1.m01 * paramMatrix4f2.m03 + paramMatrix4f1.m11 * paramMatrix4f2.m13
                        + paramMatrix4f1.m21 * paramMatrix4f2.m23 + paramMatrix4f1.m31 * paramMatrix4f2.m33;

                float f9 = paramMatrix4f1.m02 * paramMatrix4f2.m00 + paramMatrix4f1.m12 * paramMatrix4f2.m10
                        + paramMatrix4f1.m22 * paramMatrix4f2.m20 + paramMatrix4f1.m32 * paramMatrix4f2.m30;
                float f10 = paramMatrix4f1.m02 * paramMatrix4f2.m01 + paramMatrix4f1.m12 * paramMatrix4f2.m11
                        + paramMatrix4f1.m22 * paramMatrix4f2.m21 + paramMatrix4f1.m32 * paramMatrix4f2.m31;
                float f11 = paramMatrix4f1.m02 * paramMatrix4f2.m02 + paramMatrix4f1.m12 * paramMatrix4f2.m12
                        + paramMatrix4f1.m22 * paramMatrix4f2.m22 + paramMatrix4f1.m32 * paramMatrix4f2.m32;
                float f12 = paramMatrix4f1.m02 * paramMatrix4f2.m03 + paramMatrix4f1.m12 * paramMatrix4f2.m13
                        + paramMatrix4f1.m22 * paramMatrix4f2.m23 + paramMatrix4f1.m32 * paramMatrix4f2.m33;

                float f13 = paramMatrix4f1.m03 * paramMatrix4f2.m00 + paramMatrix4f1.m13 * paramMatrix4f2.m10
                        + paramMatrix4f1.m23 * paramMatrix4f2.m20 + paramMatrix4f1.m33 * paramMatrix4f2.m30;
                float f14 = paramMatrix4f1.m03 * paramMatrix4f2.m01 + paramMatrix4f1.m13 * paramMatrix4f2.m11
                        + paramMatrix4f1.m23 * paramMatrix4f2.m21 + paramMatrix4f1.m33 * paramMatrix4f2.m31;
                float f15 = paramMatrix4f1.m03 * paramMatrix4f2.m02 + paramMatrix4f1.m13 * paramMatrix4f2.m12
                        + paramMatrix4f1.m23 * paramMatrix4f2.m22 + paramMatrix4f1.m33 * paramMatrix4f2.m32;
                float f16 = paramMatrix4f1.m03 * paramMatrix4f2.m03 + paramMatrix4f1.m13 * paramMatrix4f2.m13
                        + paramMatrix4f1.m23 * paramMatrix4f2.m23 + paramMatrix4f1.m33 * paramMatrix4f2.m33;
        ...
        public boolean equals(Matrix4f paramMatrix4f)
        {
            try
            {
                return ((this.m00 == paramMatrix4f.m00) && (this.m01 == paramMatrix4f.m01)
                        && (this.m02 == paramMatrix4f.m02) && (this.m03 == paramMatrix4f.m03)
                        && (this.m10 == paramMatrix4f.m10) && (this.m11 == paramMatrix4f.m11)
                        && (this.m12 == paramMatrix4f.m12) && (this.m13 == paramMatrix4f.m13)
                        && (this.m20 == paramMatrix4f.m20) && (this.m21 == paramMatrix4f.m21)
                        && (this.m22 == paramMatrix4f.m22) && (this.m23 == paramMatrix4f.m23)
                        && (this.m30 == paramMatrix4f.m30) && (this.m31 == paramMatrix4f.m31)
                        && (this.m32 == paramMatrix4f.m32) && (this.m33 == paramMatrix4f.m33));
            }
        ...
        public boolean equals(Object paramObject)
        {
            try
            {
                ...
                return ((this.m00 == localMatrix4f.m00) && (this.m01 == localMatrix4f.m01)
                        && (this.m02 == localMatrix4f.m02) && (this.m03 == localMatrix4f.m03)
                        && (this.m10 == localMatrix4f.m10) && (this.m11 == localMatrix4f.m11)
                        && (this.m12 == localMatrix4f.m12) && (this.m13 == localMatrix4f.m13)
                        && (this.m20 == localMatrix4f.m20) && (this.m21 == localMatrix4f.m21)
                        && (this.m22 == localMatrix4f.m22) && (this.m23 == localMatrix4f.m23)
                        && (this.m30 == localMatrix4f.m30) && (this.m31 == localMatrix4f.m31)
                        && (this.m32 == localMatrix4f.m32) && (this.m33 == localMatrix4f.m33));
            }
        ...
        {
            float f1 = this.m00 * paramTuple4f1.x + this.m01 * paramTuple4f1.y + this.m02 * paramTuple4f1.z
                    + this.m03 * paramTuple4f1.w;

            float f2 = this.m10 * paramTuple4f1.x + this.m11 * paramTuple4f1.y + this.m12 * paramTuple4f1.z
                    + this.m13 * paramTuple4f1.w;

            float f3 = this.m20 * paramTuple4f1.x + this.m21 * paramTuple4f1.y + this.m22 * paramTuple4f1.z
                    + this.m23 * paramTuple4f1.w;

            paramTuple4f2.w = (this.m30 * paramTuple4f1.x + this.m31 * paramTuple4f1.y + this.m32 * paramTuple4f1.z
                    + this.m33 * paramTuple4f1.w);
        ...
        {
            float f1 = this.m00 * paramTuple4f.x + this.m01 * paramTuple4f.y + this.m02 * paramTuple4f.z
                    + this.m03 * paramTuple4f.w;

            float f2 = this.m10 * paramTuple4f.x + this.m11 * paramTuple4f.y + this.m12 * paramTuple4f.z
                    + this.m13 * paramTuple4f.w;

            float f3 = this.m20 * paramTuple4f.x + this.m21 * paramTuple4f.y + this.m22 * paramTuple4f.z
                    + this.m23 * paramTuple4f.w;

            paramTuple4f.w = (this.m30 * paramTuple4f.x + this.m31 * paramTuple4f.y + this.m32 * paramTuple4f.z
        ...
        */
        ...
        public final void setRotation(Quat4f paramQuat4f)
        {
            ...
            this.m00 = (float)((1.0F - (2.0F * paramQuat4f.y * paramQuat4f.y) - (2.0F * paramQuat4f.z * paramQuat4f.z))
                    * arrayOfDouble2[0]);
            this.m10 = (float)(2.0F * (paramQuat4f.x * paramQuat4f.y + paramQuat4f.w * paramQuat4f.z) * arrayOfDouble2[0]);
            this.m20 = (float)(2.0F * (paramQuat4f.x * paramQuat4f.z - (paramQuat4f.w * paramQuat4f.y))
                    * arrayOfDouble2[0]);

            this.m01 = (float)(2.0F * (paramQuat4f.x * paramQuat4f.y - (paramQuat4f.w * paramQuat4f.z))
                    * arrayOfDouble2[1]);
            this.m11 = (float)((1.0F - (2.0F * paramQuat4f.x * paramQuat4f.x) - (2.0F * paramQuat4f.z * paramQuat4f.z))
                    * arrayOfDouble2[1]);
            ...
            this.m12 = (float)(2.0F * (paramQuat4f.y * paramQuat4f.z - (paramQuat4f.w * paramQuat4f.x))
                    * arrayOfDouble2[2]);
            this.m22 = (float)((1.0F - (2.0F * paramQuat4f.x * paramQuat4f.x) - (2.0F * paramQuat4f.y * paramQuat4f.y))
                    * arrayOfDouble2[2]);
        }
        ...
        public final void setRotation(AxisAngle4f paramAxisAngle4f)
        {
            ...
            double d1 = Math.sqrt(paramAxisAngle4f.x * paramAxisAngle4f.x + paramAxisAngle4f.y * paramAxisAngle4f.y
                    + paramAxisAngle4f.z * paramAxisAngle4f.z);
            if (d1 < 1.0E-008D)
            {
                this.m00 = 1.0F;
