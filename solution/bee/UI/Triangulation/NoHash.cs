...
namespace Bee.UI.Triangulation
{
    public class NoHash
    {
        ...
        public static void insertAfterVtx(Triangulator triRef, int iVtx)
        {
            int size;
            ...
            else if (triRef.numVtxList >= triRef.vtxList.Length)
            {
                ...
                triRef.vtxList = new PntNode[size];
                Array.Copy(old, 0, triRef.vtxList, 0, old.Length);
            }
        ...
        public static void deleteFromList(Triangulator triRef, int i)
        {
            int indPnt, indPnt1;
            int indVtx;
        ...
        public static bool inVtxList(Triangulator triRef, int vtx)
        {
            return ((0 <= vtx) && (vtx < triRef.numVtxList));
        }


        public static void freeNoHash(Triangulator triRef)
        {
