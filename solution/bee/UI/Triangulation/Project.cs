    ...
    public class Project
    {
        ...
        public static void projectFace(Triangulator triRef, int loopMin, int loopMax)
        {
            ...
            if (j < loopMax)
            {
                ...
                {
                    Basic.divScalar((float)d, normal);
                }
                else
                {
         ...
         */
        public static void determineNormal(Triangulator triRef, int ind, Vector3f normal)
        {
            Vector3f nr, pq, pr;
            int ind0, ind1, ind2;
            int i0, i1, i2;
         ...
         * length!
         */
        public static void projectPoints(Triangulator triRef, int i1, int i2, Vector3f n3)
        {
            ...
            d = Basic.lengthL2(n1);
            Basic.divScalar((float)d, n1);
            Basic.vectorProduct(n1, n3, n2);
            d = Basic.lengthL2(n2);
            Basic.divScalar((float)d, n2);
